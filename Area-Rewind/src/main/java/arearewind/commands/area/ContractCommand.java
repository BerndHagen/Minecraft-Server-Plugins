...
public class ContractCommand extends BaseCommand {
    ...
    public ContractCommand(JavaPlugin plugin, AreaManager areaManager, BackupManager backupManager,
    ...
    public String getDescription() {
        return "Contract an area in a specific direction";
    }

    @Override
    public String getUsage() {
        return "/rewind contract <area> <direction> <amount>";
    }
}
