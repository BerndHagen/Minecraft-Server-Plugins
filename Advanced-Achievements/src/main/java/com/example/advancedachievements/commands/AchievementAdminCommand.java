...
public class AchievementAdminCommand implements CommandExecutor, TabCompleter {
    ...
    private boolean handleCreate(CommandSender sender, String[] args) {
        if (args.length < 8) {
            sender.sendMessage("§cUsage: /achadmin create <id> <title> <description> <category> <icon> <tasktype> <target> <amount> [rewards...]");
            return true;
        }
        ...
        Material icon;
        try {
            icon = Material.valueOf(args[5].toUpperCase());
        } catch (IllegalArgumentException e) {
            sender.sendMessage("§cInvalid material: " + args[5]);
            return true;
        }
        
        TaskType taskType = TaskType.fromId(args[6]);
        if (taskType == null) {
            sender.sendMessage("§cInvalid task type: " + args[6]);
        ...
        try {
            ...
            sender.sendMessage("§cInvalid amount: " + args[8]);
            return true;
        }
        ...
        Achievement achievement = plugin.getAchievementManager().createAchievement(
            id, title, description, category, icon, taskType, target, amount, rewards, 
            plugin.getConfigManager().getDefaultPoints(), false, new ArrayList<>()
        );
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sender.sendMessage("§7/achadmin create <id> <title> <desc> <category> <icon> <tasktype> <target> <amount> [rewards...] §f- Create achievement");
        ...
        sender.sendMessage("§7/achadmin list [category] §f- List all achievements");
        ...
        sender.sendMessage("§6Editable Properties: §ftitle, description, category, icon, target, amount, rewards, points, hidden");
    ...
    private boolean handleEdit(CommandSender sender, String[] args) {
        if (args.length < 4) {
            ...
            sender.sendMessage("§7Properties: title, description, category, icon, target, amount, rewards, points, hidden");
            return true;
        }
        ...
        try {
            switch (property) {
                ...
                case "rewards":
                    ...
                    break;
                default:
                    sender.sendMessage("§cInvalid property! Available: title, description, category, icon, target, amount, rewards, points, hidden");
                    return true;
            }
    ...
    private boolean handleAdminList(CommandSender sender, String[] args) {
        ...
        sender.sendMessage("§6All Achievements" + (category != null ? " - " + category : "") + " (" + achievements.size() + "):");
    ...
    private boolean handleAdminInfo(CommandSender sender, String[] args) {
        ...
        sender.sendMessage("§7Category: §f" + achievement.getCategory());
        ...
        sender.sendMessage("§7Points: §f" + achievement.getPoints());
